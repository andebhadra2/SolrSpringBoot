 ...
 * 
 */
package com.solr.app.controller;
...
import com.solr.app.repository.CustomSolrOrderRepository;
import com.solr.app.repository.SolrOrderRepository;
...
public class OrderController {
	...
	@Autowired
	CustomSolrOrderRepository customSolrOrderRepository;
	...
	public List<Order> readAllOrder(){
		return customSolrOrderRepository.findAllOrders();
	}
